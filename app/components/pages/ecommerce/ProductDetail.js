      ...
      <ScrollView>
        <Card>
          ...
          <Card.Title style={styles.titlesty}>
            <Text style={styles.headText}>{detail?.title}</Text> 
          </Card.Title>
          <Text style={styles?.RatingSty}>Rating : {detail?.rate}</Text>
          <Text style={styles?.priceSty}>Harga : Rp {detail?.price}</Text>
          <Text style={styles?.descStyle}>
            <Text style={styles?.headText}>Deskripsi : </Text>
            {detail?.description}
          </Text>
          <Card.Divider />
          {/* <Button
